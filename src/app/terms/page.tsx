        ...
        <div className="space-y-6 text-white opacity-90">
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              refrain from engaging in harmful activities such as hacking,
              spreading malware, or using the Service for illegal purposes. Any
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              Terms or your use of the Service shall be resolved exclusively in
